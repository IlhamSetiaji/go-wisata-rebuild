                ...
                <div class="offset-0 col-12 d-none d-lg-flex offset-md-1 col-lg h-lg-100">
                    <div class="min-h-100 d-flex align-items-center">
                        <div class="w-100 w-lg-75 w-xxl-50">
                            <div>
                                <div class="mb-5">
                                    <h1 class="display-3 text-white">Go-Wisata ID</h1>
                                </div>
                                <p class="h6 text-white lh-1-5 mb-5">
                                    Go-Wisata membantu Anda untuk dapat menemukan tempat wisata yang paling keren dan
                                    menyenangkan dengan harga terbaik , Cari tempat liburan anda sekarang!
                                </p>
                                <div class="mb-5">
                                    <a class="btn btn-lg btn-outline-white" href="{{ url('/') }}">Back to Dashboard</a>
                                </div>
                            </div>
                        </div>
                    </div>
